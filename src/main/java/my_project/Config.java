...
public class Config {
    ...
    public final static String WINDOW_TITLE = "Fortnite 2D";
    ...
    public final static int WINDOW_HEIGHT = 1027+29;   // Effektive Höhe ist etwa 29 Pixel geringer (Titelleiste wird mitgezählt)
