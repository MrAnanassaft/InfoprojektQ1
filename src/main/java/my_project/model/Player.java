...
public class Player extends InteractiveGraphicalObject {
    ...
    private String playerImageBlackbearLeft = "src/main/resources/graphic/skins/Skin BlackbearLeft.png";
    private String playerImageHotdog = "src/main/resources/graphic/skins/Skin Hotdog.png";
    private String playerImageHotdogLeft ="src/main/resources/graphic/skins/Skin HotdogLeft.png";
    private String playerImageMan = "src/main/resources/graphic/skins/Skin Man.png";
    private String playerImageManLeft ="src/main/resources/graphic/skins/Skin ManLeft.png";
    private String playerImageManStreched = "src/main/resources/graphic/skins/Skin ManStretched.png";
    private String playerImageManStrechedLeft ="src/main/resources/graphic/skins/Skin ManStretchedLeft.png";
    ...
    public void draw(DrawTool drawTool) {
        ...
        if (selectBlackbear){
            if (direction == 1){
                ...
                setNewImage(playerImageBlackbearLeft);
                drawTool.drawTransformedImage(getMyImage(), x, y + 15, 0, 1);
            }
            ...
            if (direction == 1){
                ...
                setNewImage(playerImageHotdogLeft);
                drawTool.drawTransformedImage(getMyImage(), x, y + 15, 0, 1);
            }
            ...
            if (direction == 1){
                ...
                setNewImage(playerImageManLeft);
                drawTool.drawTransformedImage(getMyImage(), x, y + 15, 0, 1);
            }
            ...
            if (direction == 1){
                ...
                setNewImage(playerImageManStrechedLeft);
                drawTool.drawTransformedImage(getMyImage(), x, y + 15, 0, 1);
            }
        }
    ...
    public void update(double dt) {
        ...
        if (x > viewController.getDrawFrame().getWidth()){
            x = -getMyImage().getWidth() + 1;
        }
        if (x < -getMyImage().getWidth() - 1){
            x = viewController.getDrawFrame().getWidth() - 1;
        }
    ...
    public void shoot() {
        ...
        if (degree >= 90 && degree <= 270) {
            ...
            playerImageSniper = "src/main/resources/graphic/weapons/Sniperreversed.png";
        } else {
